...
Main Lights - 
    ...
    <form action="/var/www/html/1.py" method="post" align="center">
    ...
    <form action="/var/www/html/2.py" method="get" align="center">
    <button type="submit" name="iainslights" id="iainslights">Iains Lights</button>
    </form>
    <h2 align="center">
    Eloras Lights - 
    
    <form action="/var/www/html/3.py" method="get" align="center">
